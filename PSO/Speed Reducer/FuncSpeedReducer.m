...
for i=1:size(X,1)
    x=X(i,:);
    f(i)=0.7854*x(1)*x(2)^2*(3.3333*x(3)^2+...
...
%x=[3.49999999999760 0.700000000000000 17 7.30000000000001 7.80000000000000 3.35021466609630 5.28668322975692;];
g=[];
